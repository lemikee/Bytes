...
user1 = User.create(first_name: 'Yu-Huan', last_name: 'Wu', email: 'yuhuan@me.com', password: 'password', zip_code: '94101')
user2 = User.create(first_name: 'Darrick', last_name: 'Shin', email: 'darrick@me.com', password: 'password', zip_code: '94102')
user3 = User.create(first_name: 'Alex', last_name: 'Crooks', email: 'alex@me.com', password: 'password', zip_code: '94110')
user4 = User.create(first_name: 'Arwen', last_name: 'Kim', email: 'arwen@me.com', password: 'password', zip_code: '94015')
user5 = User.create(first_name: 'Ian', last_name: 'McGrath', email: 'ian@me.com', password: 'password', zip_code: '94530')
user6 = User.create(first_name: 'Vincent', last_name: 'Hsu', email: 'vincent@me.com', password: 'password', zip_code: '90503')
user7 = User.create(first_name: 'Jason', last_name: 'Kim', email: 'jason@me.com', password: 'password', zip_code: '94118')
user8 = User.create(first_name: 'Jimmy', last_name: 'Kuang', email: 'jimmy@me.com', password: 'password', zip_code: '90001')
user9 = User.create(first_name: 'Josh', last_name: 'Zhao', email: 'josh@me.com', password: 'password', zip_code: '90504')
user10 = User.create(first_name: 'Jim', last_name: 'Nardi', email: 'jim@me.com', password: 'password',  zip_code: '91001')
user11 = User.create(first_name: 'Danny', last_name: 'Park', email: 'danny@me.com', password: 'password',  zip_code: '10001')
user12 = User.create(first_name: 'Vern', last_name: 'Chao', email: 'vern@me.com', password: 'password',  zip_code: '52862')
user13 = User.create(first_name: 'Joey', last_name: 'Fernandez', email: 'joey@me.com', password: 'password',  zip_code: '18593')
user14 = User.create(first_name: 'Josh', last_name: 'Kim-Biggs', email: 'joshkb@me.com', password: 'password',  zip_code: '96282')
user15 = User.create(first_name: 'Kenny', last_name: 'La', email: 'kenny@me.com', password: 'password',  zip_code: '85718')
user16 = User.create(first_name: 'Hitch', last_name: 'Elalam', email: 'hitch@me.com', password: 'password',  zip_code: '58286')
user17 = User.create(first_name: 'John', last_name: 'Feng', email: 'john@me.com', password: 'password',  zip_code: '86926')
user18 = User.create(first_name: 'Jon', last_name: 'Zamora', email: 'jon@me.com', password: 'password',  zip_code: '93015')
user19 = User.create(first_name: 'David', last_name: 'Oh', email: 'david@me.com', password: 'password',  zip_code: '52869')
user20 = User.create(first_name: 'Masa', last_name: 'Cheung', email: 'masa@me.com', password: 'password',  zip_code: '58296')
user21 = User.create(first_name: 'Tony', last_name: 'Zhang', email: 'tony@me.com', password: 'password',  zip_code: '19395')
user22 = User.create(first_name: 'Andrew', last_name: 'Roellig', email: 'andrew@me.com', password: 'password',  zip_code: '14869')
user23 = User.create(first_name: 'Anusha', last_name: 'Tuladhar', email: 'anusha@me.com', password: 'password',  zip_code: '28582')
user24 = User.create(first_name: 'Connor', last_name: 'Germain', email: 'connor@me.com', password: 'password',  zip_code: '39573')
...
business1 = Business.create(business_name: 'App Academy', address: '825 Battery St', city: 'San Francisco',
                            state: 'CA', zip_code: '94111', latitude: 37.79911533694061, longitude: -122.40128226484526, phone: '(415) 417-1991', website: 'appacademy.io', price: '$$$')
...
# App Academy
business1.photo.attach(io: File.open('./app/assets/images/business/1-app/app1.jpeg'), filename: 'app1-1.jpg')
business1.pics.attach(io: File.open('./app/assets/images/business/1-app/app1.jpeg'), filename: 'app1.jpeg')
business1.pics.attach(io: File.open('./app/assets/images/business/1-app/app2.png'), filename: 'app2.png')
business1.pics.attach(io: File.open('./app/assets/images/business/1-app/app3.png'), filename: 'app3.png')
business1.pics.attach(io: File.open('./app/assets/images/business/1-app/app4.png'), filename: 'app4.png')
business1.pics.attach(io: File.open('./app/assets/images/business/1-app/app5.png'), filename: 'app5.png')
business1.pics.attach(io: File.open('./app/assets/images/business/1-app/app6.png'), filename: 'app6.png')
business1.pics.attach(io: File.open('./app/assets/images/business/1-app/app7.png'), filename: 'app7.png')
business1.pics.attach(io: File.open('./app/assets/images/business/1-app/app8.jpeg'), filename: 'app8.jpeg')
...
Review.create(business_id: business1.id, user_id: user9.id, rating: 4,
              body: 'The food is great but at $17k its a bit expensive.')
Review.create(business_id: business1.id, user_id: user12.id, rating: 4,
              body: "App academy is the best restaurant I've ever been. The ambiance is nice and dark so it doesn't attract many bugs. My instructors are great bug exterminators. Every day on zoom, I get served a big project with a side of homework. 5/5 would recommend.")
Review.create(business_id: business1.id, user_id: user18.id, rating: 3,
              body: 'The best thing to happen to the food industry since Taco Bell')
...
Review.create(business_id: business2.id, user_id: user7.id, rating: 5, body: 'During COViD you cannot walk in and order. The only way they take orders is by phone so the guy told us to go outside and call in our order. Went outside and called in 12 wings and they told me it would be a 15 minute wait so we went next door to Peasant Pies while we waited and grabbed dessert.')
Review.create(business_id: business2.id, user_id: user10.id, rating: 4, body: "I was recommended this place and was told the they had the most amazing wings. Let me tell you they did not disappoint! They are nice and crispy and flavorful! Also had the most amazing chow main I've had. For sure. It is open for take out only so make sure you call ahead as they won't take your order in person. Definitely lives up to the hype from these reviews.")
...
Review.create(business_id: business3.id, user_id: user12.id, rating: 5, body: "If you're looking for the best place to eat at in the touristy Pier 39, this is probably the place to be. Albeit the food isn't the best, you have to take into consideration the location and views. Side note, I would NOT recommend choosing an outdoor eating locations, the winds, birds, and atmosphere do not make a great dining experience")
Review.create(business_id: business3.id, user_id: user22.id, rating: 5, body: 'Make a reservation immediately. Went here to watch the sunset and eat some delicious food, but as we walked up the steps to the restaurant we heard a couple who was leaving say that it was some of the best food they ever had, which had my hopes up.')
Review.create(business_id: business3.id, user_id: user24.id, rating: 5, body: 'I would give this restaurant more than 5 stars if I could. Pier 39 has lots of nice attractions and restaurants, and I think Fog Harbor is the best. I reserved ahead of time and parking is available across the street in the garage')
...
Review.create(business_id: business5.id, user_id: user18.id, rating: 4, body: "Bob's Donuts is a 24-hour donut and pastry shop on Polk St (near Clay) in San Francisco.  This popular donut shop is known for it's fresh and delicious donuts, as well as it's giant donuts.  ")
Review.create(business_id: business5.id, user_id: user21.id, rating: 3, body: "So, true to form, this is simply a donut shop to me.  Not bad, but not a destination dining with any specially exclusive unique offering that would have me rant nor rave or praise it above and beyond their peer donut shop competitors.")
Review.create(business_id: business5.id, user_id: user24.id, rating: 4, body: "The gentleman working at the counter was friendly and patient. He recommended the apple fritter. It was HUGE and so worth it. It's really light and airy. It is sweet but not overwhelmingly so. I highly recommend having some water or coffee nearby.")
...
Review.create(business_id: business7.id, user_id: user13.id, rating: 5, body: "Super meal at ppq, ordered roast crab, signature crab, crab noodles, and greens, pretty good portion size for 4pax. Crabs are expensive but that's the price of Dungeness now!")
...
Review.create(business_id: business8.id, user_id: user19.id, rating: 5, body: "THIS PLACE IS A SOLID FLAG CARRIER OF ITALIAN CUISINE. Feeling freshness on every bite. I got the meat ravioli w pesto and was terrific. I also tried the fettuccine w shrimps special that was so good as well. Loved it definitely recommended for everyone who craves for italian.")
Review.create(business_id: business8.id, user_id: user20.id, rating: 3, body: "Went in for lunch trying to get some nice filling pasta. Linguini with meatball came out as a nice big portion, pretty tasty meatball too. Unfortunately the gnocchi with white sauce was super disappointing. Seating for us was outside, as soon as it got a little bit cooler (which is very soon) , the gnocchi was pretty depressing as cold gnocchi is.")
...
Review.create(business_id: business9.id, user_id: user24.id, rating: 5, body: "Solid Italian! Very healthy portions. No complaints - not the best Italian food you have ever had, but DELICIOUS - just a little more homestyle versus fine dining.")
Review.create(business_id: business9.id, user_id: user25.id, rating: 4, body: "Very good pasta! Warmed my heart and stomach")
...
Review.create(business_id: business10.id, user_id: user19.id, rating: 3, body: "The food is decent, but more hyper than anything.")
Review.create(business_id: business10.id, user_id: user16.id, rating: 5, body: "All workers masked up. Knowledgeable server and polite. Fast service. Door kept open maybe for better ventilation, which I didn't mind. Bathroom clean, but air drying hands which I personally do not prefer.")
...
Review.create(business_id: business11.id, user_id: user9.id, rating: 5, body: "I managed to snag a last minute reservation with some friends on a Saturday night, and we had such a great time! The food and experience were both fantastic and I would definitely come back again.")
Review.create(business_id: business11.id, user_id: user6.id, rating: 2, body: "The service was just ok, our waitress kept forgetting a lot of things and had forgotten to give us an appetizer.")
...
Review.create(business_id: business13.id, user_id: user12.id, rating: 3, body: "Tbh our ramens just didn't taste as great as I remember this place being. I used to walk all the way from work in soma just to stand in line for an hour+. This time around we went really late so there wasn't a wait at all. Perhaps since we went later, the quality of the ramen just wasn't as good?")
...
Review.create(business_id: business14.id, user_id: user5.id, rating: 4, body: "The inside is absolutely beautiful and there are usually films playing in the patio area. The quality of the dishes showed through the flavors, although the portions were quite small. The stars of the meal were the duck confit and the peach dessert, which ended the meal on a great note. The halibut was a little bland for our taste, although the soup was very flavorful. I'd come back for a special occasion - ambience and service were impeccable")
Review.create(business_id: business14.id, user_id: user6.id, rating: 4, body: "This brunch place has pretty good vibe and atmosphere with beautiful interior, but unfortunately the food didn't live up to my standard.  Dishes here are pretty pricey and small portions and they were not particularly good either. I think it's a good place for light brunch with booze to enjoy some aesthetic vibe, but if you're looking for some good food, this is not the place.  ")

# Burma Superstar
Review.create(business_id: business15.id, user_id: user7.id, rating: 5, body: "The Beef Curry was deeply flavorful, the beef wonderfully braised, and the sauce soaked up with the provided rice. Lunch was great!")
Review.create(business_id: business15.id, user_id: user8.id, rating: 4, body: "My friend and I shared a rainbow salad and I ordered Nian Pa Dok (a flat noodle dish with curry). Because I'm a hulking, ridiculously tall girl, I naturally like to eat--probably more than what my stomach can fit in, but I manage to store the food someplace unknown. I'm a cow..I probably have 4 stomach compartments. Heh.")
Review.create(business_id: business15.id, user_id: user9.id, rating: 5, body: "We really enjoyed the two noodle soup dishes.  They were very flavorful and truly reminded my husband of his childhood.  ")
Review.create(business_id: business15.id, user_id: user10.id, rating: 1, body: "To start with this was my 2nd time at the restaurant as I loved the food first time and we decided to revisit the place. However was highly disappointed with my high expectations!")
Review.create(business_id: business15.id, user_id: user11.id, rating: 4, body: "Definitely recommend the fiery vegetables with tofu!! came here on a saturday night around 6pm and the wait was around 25 minutes to be seated outside (with heat lamps!). service was good and food was reasonably priced. the chicken curry dahl, rainbow salad (ordered a large but quantity was not much), and the garlic noodles were pretty good (maybe not my personal preference). but overall, i would recommend! especially if you want to try or just like burmese food")
...
Review.create(business_id: business16.id, user_id: user18.id, rating: 5, body: "Love this spot! I prefer this for Happy Hour and nibbles vs a dinner spot. BOMB margaritas! My favorite and go to is the Hibiscus margarita in a pitcher. The tacos are delicious but if you want to switch it up, try every flavor (especially potato) tacos delgados! And their Tortilla soup is super tasty and filling.")
Review.create(business_id: business16.id, user_id: user19.id, rating: 4, body: "Food was really good, the bottomless mimosas were a plus, just wish they had a few more options for flavors to miss with the brute. Tacos were so good!")
